                ...
                <div className={css.utility__content}>
                    <div className={cn(css.utility__content_el1, css.reason)}>
                        ...
                        <div className={css.reason__text}>
                            Алгоритм - конечная совокупность точно заданных правил решения некоторого класса задач или
                    ...
                    <div className={cn(css.utility__content_el2, css.reason)}>
                        ...
                        <div className={css.reason__text}>
                            Вычислительная машина, счётная машиина — механизм, электромеханическое или электронное
